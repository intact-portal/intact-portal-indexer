...
@Component
public class ClusteredInteractionIndexerTasklet implements Tasklet {

    private static final Log log = LogFactory.getLog(ClusteredInteractionIndexerTasklet.class);
    ...
    @Resource
    private SolrClient clusteredInteractionSolrServer;
    ...
    private void solrServerCheck() {
        if (attempts < MAX_ATTEMPTS) {
            try {
                ...
                SolrPingResponse response = clusteredInteractionSolrServer.ping();
